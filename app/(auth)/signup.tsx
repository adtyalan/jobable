          ...
          <View style={styles.card}>
            ...
            <View style={styles.roleSelector}>
              <Pressable
                style={[
                  styles.roleButton,
                  role === "pencari_kerja" && styles.roleButtonActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.roleText,
                    role === "pencari_kerja" && styles.roleTextActive,
                  ]}
                >
                  Pencari Kerja
                </Text>
              ...
              <Pressable
                style={[
                  styles.roleButton,
                  role === "perusahaan" && styles.roleButtonActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.roleText,
                    role === "perusahaan" && styles.roleTextActive,
                  ]}
                >
                  Perusahaan
                </Text>
